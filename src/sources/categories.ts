...
export const CATEGORIES: NewsCategory[] = [
  ...
  },
  {
    ...
    label: '国际中文',
    short: '国际中文',
    caption: 'BBC · 纽约时报 · RFI · DW · FT · 联合早报 · VOA · 中央社 · 端传媒',
    sourceIds: [
      'bbc-zh',
      'nytimes-zh',
      'rfi-zh',
  ...
  ),
  {
    ...
    label: '国际英文',
    short: '国际英文',
    caption: 'BBC · DW · NYT · WSJ · Nikkei Asia · CNA · SCMP · NPR · Guardian · France 24 · Al Jazeera',
    sourceIds: [
      'bbc-world',
      'dw-en',
      'nytimes-world',
  ...
  },
  {
    ...
    label: '国际英文·深读',
    short: '国际深读',
    caption: 'Foreign Affairs · NYRB · Bloomberg Opinion · Project Syndicate · Sinocism',
    sourceIds: ['foreign-affairs', 'nyrb', 'bloomberg-opinion', 'project-syndicate', 'sinocism'],
  },
...
export const PORTAL_CATEGORY_SOURCES: Record<CategoryId, string[]> = {
  ...
  intl: ['bbc-zh', 'nytimes-zh', 'rfi-zh', 'dw-top', 'ftchinese', 'zaobao-world', 'theinitium'],
